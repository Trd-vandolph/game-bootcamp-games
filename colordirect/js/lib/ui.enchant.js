 ...
 * @type {Object}
 */
FONT_LINK = './img/font1.png';
enchant.ui = { assets: ['./img/pad.png', FONT_LINK] };
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets[FONT_LINK],
...
enchant.ui.TimeLabel = enchant.Class.create(enchant.ui.MutableText, {
    ...
    time: {
        get: function() {
            return (this._time / enchant.Game.instance.fps)*10E2%10E4/10E2;
        },
